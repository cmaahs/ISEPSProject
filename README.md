...
OUTPUTS
    ...
    PS C:\>New-PspPowershellProject ISEPSProject
...
PARAMETERS
    ...
    -IncludeInBuild [<SwitchParameter>]
        ...
        Required?                    false
        Position?                    5
        Default value                (Get-PspPowershellProjectDefaultIncludeInBuild)
        Accept pipeline input?       false
        Accept wildcard characters?  false
...
OUTPUTS
    ...
    PS C:\>$default = "" | Select-Object ProjectFile,IncludeInBuild,BuildStyle
