...
Function Create-PowershellProject
{
    ...
    End
    {
        ...
        {
            #Set Defaults
            Set-PowershellProjectDefaults -ProjectFile $ProjectFileToCreate -IncludeInBuild No -BuildStyle IncludeStyle
...
"@
                ...
                #Add PSD to Defaults
                Set-PowershellProjectDefaults -ModulePSDFile $psdFileName
                Add-SourceToPowershellProject -ProjectFile $ProjectFileToCreate -SourceFile $psdFileName
                Set-PowershellProjectDefaults -IncludeInBuild Yes
            } else {
